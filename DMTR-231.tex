...
\label{sect:objectives}
 ...
 This test verifies that DM software are ready to obtain and process
ComCam observations. ~Since this verification element is needed prior to
on-sky data acquisition the tests are necessarily focused on the ability
to process test-stand data. ~It is worth noting that a variety of
...
software base to encompass specialized processing is assumed to be
present).
