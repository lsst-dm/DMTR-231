...
\def\milestoneName{All P1a DM requirements verified.}
\def\milestoneId{LDM-503-19a}
\def\testplanId{LVV-P72}
\def\product{Data Management}

\setDocCompact{true}

\title{\testplanId: \milestoneId\,\textendash\,\milestoneName }
...
\setDocAbstract{
This is the test plan an report for \textbf{All P1a DM requirements verified}\,(LDM-503-19a),
...
\label{sect:objectives}
 ...
 This test plan verifies that DM software and services are ready for on-sky commissioning. 
...
\citeds{LSE-61}: Data Management Requirements Specification \\
...
\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testPlan/LVV-P76}{LVV-P72}
